  ...
  return <div className="reimbursement-app">
    <main className="workbench-main">
      <header className="workbench-header">
        <div className="workbench-identity"><span className="workbench-mark"><Icon name="receipt" size={24} /></span><div><h1>报销流程</h1><p><span>ChatGPT / Claude</span><span>{years} 年</span><span>{isRemoteAPI() ? '云端工作区' : '本地工作区'}</span></p></div></div>
